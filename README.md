...
- Clone the forked repository into your local machine by using `$ git clone` in the terminal, remember that this will create a NEW folder with the repository's name that you can then cd into.
